...
Now that you know what commands we will have to run, we can setup up a **workflow** in GitHub Actions. 

The workflow is a script written in **YAML**, a mark-up language that resembles json.
