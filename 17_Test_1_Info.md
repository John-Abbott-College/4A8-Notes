...
- Providing example usage of the classes and methods in XML documentation

- Specify XML documentation for classes, methods, fields using appropriate tags

- making sure to document exceptions thrown by methods called within your method that are not caught and handled in the function itself. These exceptions can be thrown by your method -  callers of your method need to know this so they can choose how to handle these exceptions, if they occur.
