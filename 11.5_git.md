...
> Some of the things students did wrong in the last couple of years with branches
...
- Can be created locally with:

Tags do **not** include:

- Descriptions (unless annotated)
- Release notes
- Downloadable packaged files
- UI presentation

They are purely version markers.
...
A release a public, documented, packaged version of your project.
