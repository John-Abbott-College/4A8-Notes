...
In the MainWindow (or another Window in your code), you can now use your new control directly:
...
Some general info on how this code works: [tutorial](https://www.c-sharpcorner.com/UploadFile/mahesh/charting-in-wpf/)
...
`xmlns:`*`choose_namespace_name`*`=""`

set the value of the namespace to "http://schemas.microsoft.com/winfx/2006/xaml/presentation/toolkit"
          
In the following example, I chose `toolkit` to be the namespace name for the charting controls
...
### Making Chart Controls available in your code
...
namespace Budget
{
    ...
    public partial class DataChartControl : UserControl
    {
        ...
        // Inputs: usedCategoryList... a list of categories as strings
        // -----------------------------------------------------------------------------------
...
##### Pie Chart not appearing - some debugging to do

You should have fixed the API code to always have positive amounts. The pie chart code does not deal with this properly. Debug the code to find a fix once you have hooked everything up and you see that the `set_MonthCategory_Data` method is called.

##### Weird build errors?

If you get build errors that do not make sense, rebuild your WPF application. You might even have to close the VS solution, delete the bin and obj folders and reopen the solution in VS.

##### A nice way to generically add a data source for the grid view and pie chart view to your view interface
